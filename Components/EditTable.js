...
const EditTable = ({
  ...
  const onUpdate = async () => {
    try {
      ...
      const response = await fetch(`https://api.airtable.com/v0/appECQ2IWk4q6BHSj/${currentDatabase}?filterByFormula=SEARCH("${selectedItem.Item}", {Item})`, {
        method: 'GET',
        headers: {
      ...
      const updateResponse = await fetch(`https://api.airtable.com/v0/appECQ2IWk4q6BHSj/${currentDatabase}/${recordId}`, {
        method: 'PATCH',
        headers: {
          'Authorization': 'Bearer pato2uM4jlfP6sYN2.f7f7d5f628bd62cc66d9d5e91faf58f4f2e161fe72027e4ba343bcd3b74a40bb',
          'Content-Type': 'application/json'
      ...
      // Call handleUpdate function to update local state or perform any other necessary actions
      handleUpdate();
