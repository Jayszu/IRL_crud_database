...
const EditSubChem = ({
  isOpen, onClose,handleBackspace, selectedSubItem, handleDateRChange,
  handleItemNoChange,handlePackingChange,handleBrandChange, handleLotChange,
  handleCatalogueChange,handleExpiryChange,handlePrevBChange,handleQuanRChange,
  handleReleasedBChange,handleCurrentBChange,handleDateUChange,currentDatabase,
  handleRefresh
}) => {
  ...
  const onUpdate = async () => {
    try {
      ...
      const commonFields = {
        ...
        "Item & CAS No.": selectedSubItem.ItemNo,
        "Packing": selectedSubItem.Packing,
        "Brand": selectedSubItem.Brand,
        "Lot / Batch #":selectedSubItem.Lot,
        "Catalogue No.": selectedSubItem.Catalogue,
        "Expiry/ Retest":selectedSubItem.Expiry,
      ...
      <View style={styles.container}>
        ...
        <View style={styles.fieldsContainer}>
          ...
          <View style={styles.fieldContainer}>
            ...
            <TextInput
              style={styles.input}
              value={selectedSubItem.ItemNo}
              onChangeText={(text) => handleItemNoChange(text)}
          ...
          <View style={styles.fieldContainer}>
            ...
            <TextInput
              style={styles.input}
              value={selectedSubItem.Catalogue}
              onChangeText={(text) => handleCatalogueChange(text)}
