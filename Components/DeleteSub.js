...
const DeleteSub = ({isOpen , onClose , selectedSubItem , currentDatabase, handleRefresh}) => {
...
return (
  <Popup isOpen={isOpen} onDismiss={onClose} verticalOffset={30}>
    <View style={styles.container}>
      ...
      <Text style={styles.DeleteText}>Delete {selectedSubItem.ReleasedB} from {currentDatabase}?</Text>
      <TextInput
          style={styles.input}
